...
/* Issuer API url - this is Open Badge's hosted issuer API */
...
/* badge records file - OpenBadgifier will keep records in a text file of which badges were issued and if they were pushed to the obi. This could easily be extended to use a db later. Nice to have a lightweight solution anyone can use. This file has already been created and is in the dircetory where this settings file is. CHMOD 777*/
...
$badges_array = array(
	...
	"description" => "Earner is ready to award badges with Badget-It Gadget Lite.", 
